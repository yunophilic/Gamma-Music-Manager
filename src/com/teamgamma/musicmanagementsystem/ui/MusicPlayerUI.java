...
public class MusicPlayerUI extends VBox {
    ...
    private static final double SEEK_BAR_Y_SCALE = 3;
    private static final double SONG_PLAY_BAR_SCALE = 290;
    private static final int HEADER_FONT_SIZE = 20;
    private static final int SONG_TITLE_HEADER_SIZE = 13;
    private static final double FADED = 0.5;
    private static final double NOT_FADED = 1.0;
    private static final int TITLE_ANIMATION_TIME_MS = 5000;
    private static final double VOLUME_BUTTON_SCALE = 0.75;
    private static final int VOLUME_MAX_WIDTH = 60;
    private static final int VOLUME_MAX_HEIGHT = 1;

    private static final String PREVIOUS_ICON_PATH = "ic_skip_previous_black_48dp_1x.png";
    private static final String PLAY_ICON_PATH = "ic_play_arrow_black_48dp_1x.png";
    private static final String PAUSE_ICON_PATH = "ic_pause_black_48dp_1x.png";
    private static final String NEXT_SONG_ICON_PATH = "ic_skip_next_black_48dp_1x.png";
    private static final String VOLUME_UP_ICON_PATH = "ic_volume_up_black_48dp_1x.png";
    private static final String VOLUME_DOWN_ICON_PATH = "ic_volume_down_black_48dp_1x.png";
    private static final String VOLUME_MUTE_ICON_PATH = "ic_volume_mute_black_48dp_1x.png";
    private static final String PLAYLIST_REPEAT_ICON_PATH = "ic_repeat_black_48dp_1x.png";
    private static final String ADD_TO_PLAYLIST_ICON_PATH = "ic_playlist_add_black_48dp_1x.png";
    private static final String SONG_REPEAT_ICON_PATH = "ic_repeat_one_black_48dp_1x.png";
    private static final String MINIMODE_ON_ICON_PATH = "on-minimode.png";
    private static final String MINIMODE_OFF_ICON_PATH = "off-minimode.png";
    private static final String DELETE_SONG_ICON_PATH = "delete-song-player.png";
    private static final String DISABLED_STAR_ICON_PATH = "disabled-star.png";
    private static final String UNRATED_STAR_ICON_PATH = "unrated-star.png";
    private static final String RATED_STAR_ICON_PATH = "rated-star.png";
    private static final String MOUSE_OVER_STAR_ICON_PATH = "mouseover-star.png";
	private static final String CLEAR_RATING_ICON_PATH = "blank.png";
    ...
    private static final String MAX_VOLUME_TOOL_TIP_MESSAGE = "Max Volume";
    private static final String MUTE_VOLUME_TOOL_TIP_MESSAGE = "Mute Volume";
    ...
    private static final String DEFAULT_TIME_STRING = "0:00";
