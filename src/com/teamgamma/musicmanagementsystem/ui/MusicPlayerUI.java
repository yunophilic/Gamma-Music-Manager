...
public class MusicPlayerUI extends VBox {
    ...
    private static final String PREVIOUS_ICON_PATH = "res\\ic_skip_previous_black_48dp_1x.png";
    private static final String PLAY_ICON_PATH = "res\\ic_play_arrow_black_48dp_1x.png";
    private static final String PAUSE_ICON_PATH = "res\\ic_pause_black_48dp_1x.png";
    private static final String NEXT_SONG_ICON_PATH = "res\\ic_skip_next_black_48dp_1x.png";
    private static final String VOLUME_UP_ICON_PATH = "res\\ic_volume_up_black_48dp_1x.png";
    private static final String VOLUME_DOWN_ICON_PATH = "res\\ic_volume_down_black_48dp_1x.png";
    private static final String VOLUME_MUTE_ICON_PATH = "res\\ic_volume_mute_black_48dp_1x.png";
    private static final String PLAYLIST_REPEAT_ICON_PATH = "res\\ic_repeat_black_48dp_1x.png";
    private static final String ADD_TO_PLAYLIST_ICON_PATH = "res/ic_playlist_add_black_48dp_1x.png";
    private static final String SONG_REPEAT_ICON_PATH = "res\\ic_repeat_one_black_48dp_1x.png";
    private static final String MINIMODE_ON_ICON_PATH = "res\\on-minimode.png";
    private static final String MINIMODE_OFF_ICON_PATH = "res\\off-minimode.png";
    private static final String DELETE_SONG_ICON_PATH = "res\\delete-song-player.png";
    private static final String DISABLED_STAR_ICON_PATH = "res\\disabled-star.png";
