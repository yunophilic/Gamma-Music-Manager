...
/**
 * Class that contains context menu option strings
 */
public class ContextMenuConstants {
    public static final String COPY = "Copy";
    public static final String PASTE = "Paste";
    public static final String DELETE = "Delete";
    public static final String REMOVE_THIS_LIBRARY = "Remove This Library";
    ...
    public static final String REMOVE_FROM_PLAYLIST = "Remove From Playlist";
}
